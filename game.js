...
function setupSoldier(gltf, weaponGltf) {
  ...
  const scaleFactor = rawHeight > 0.001 ? THREE.MathUtils.clamp(TARGET_HEIGHT / rawHeight, 0.02, 50) : 1;
...
function updateSoldierCamera(dt) {
  ...
  if (input.aiming) { dist = 2.4; height = 1.75; lookHeight = 1.6; } else { dist = 4.2; height = 2.1; lookHeight = 1.5; }
